...
# Usage:
#   download_dependency_mod(owner/repo-name mod.id)
# Example:
#   download_dependency_mod(user95401/geode-game-objects-factory user95401.game-objects-factory)
# This will download the latest .geode file from the repository's release and
# extract it to `build/geode-deps/mod.id/` and create the necessary configuration.
function(download_dependency_mod REPO_NAME DEPENDENCY_ID)
    ...
    # Create geode-dep-options.json required by sdk
    file(WRITE "${OPTIONS_FILE}" "{ \"required\": true }")
    
    message(STATUS "Successfully installed dependency: '${DEPENDENCY_ID}'")
endfunction()
